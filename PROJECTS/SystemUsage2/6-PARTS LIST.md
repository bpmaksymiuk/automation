...
- **TECHNOLOGY RECOMMENDATIONS:** One `index.html` with inlined CSS and vanilla ES2020 JavaScript; CSS Grid layout; CSS custom properties for theme tokens; system font stack; no external assets.
- **NOTES:** Served by the agent and also openable directly as a file (demo mode). File: `index.html`.
- **RELATED:** AR-005, AR-008; BR-001, BR-002, BR-032, BR-034, BR-039
...
- **RELATED:** AR-006; BR-006, BR-008, BR-012, BR-014, BR-015, BR-017, BR-037
...
- **RELATED:** AR-006, AR-008; BR-019, BR-020, BR-035, BR-038, BR-NF-PERFORMANCE
